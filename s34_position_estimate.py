...
'''
File returns position estimate for image belonging to s34 class
'''
...
from ost_output_papakolea import s34
...
phi = s34.imu_tilt[0] #roll
theta = s34.imu_tilt[1] #pitch
psi = s34.imu_tilt[2] #yaw

#converts star coordinates in GCRS (which is a ECI frame) to ITRS (which is a ECEF frame)
e = main.cel2ecef(s34.time, s34.cel[0], s34.radec, 'gcrs')
e1 = main.cel2ecef(s34.time, s34.cel[1], s34.radec, 'gcrs')
e2 = main.cel2ecef(s34.time, s34.cel[2], s34.radec, 'gcrs')
e3 = main.cel2ecef(s34.time, s34.cel[3], s34.radec, 'gcrs')
e4 = main.cel2ecef(s34.time, s34.cel[4], s34.radec, 'gcrs')
e5 = main.cel2ecef(s34.time, s34.cel[5], s34.radec, 'gcrs')
e6 = main.cel2ecef(s34.time, s34.cel[6], s34.radec, 'gcrs')
e7 = main.cel2ecef(s34.time, s34.cel[7], s34.radec, 'gcrs')
e8 = main.cel2ecef(s34.time, s34.cel[8], s34.radec, 'gcrs')
e9 = main.cel2ecef(s34.time, s34.cel[9], s34.radec, 'gcrs')
e10 = main.cel2ecef(s34.time, s34.cel[10], s34.radec, 'gcrs')
e11 = main.cel2ecef(s34.time, s34.cel[11], s34.radec, 'gcrs')
e12 = main.cel2ecef(s34.time, s34.cel[12], s34.radec, 'gcrs')
e13 = main.cel2ecef(s34.time, s34.cel[13], s34.radec, 'gcrs')
e14 = main.cel2ecef(s34.time, s34.cel[14], s34.radec, 'gcrs')
e15 = main.cel2ecef(s34.time, s34.cel[15], s34.radec, 'gcrs')
e16 = main.cel2ecef(s34.time, s34.cel[16], s34.radec, 'gcrs')
e17 = main.cel2ecef(s34.time, s34.cel[17], s34.radec, 'gcrs')
e18 = main.cel2ecef(s34.time, s34.cel[18], s34.radec, 'gcrs')
e19 = main.cel2ecef(s34.time, s34.cel[19], s34.radec, 'gcrs')
e20 = main.cel2ecef(s34.time, s34.cel[20], s34.radec, 'gcrs')
ev = main.cel2ecef(s34.time, s34.cel[13], s34.radec, 'radec2car')
...
i = np.array([-0.95718927, -0.28725176, -0.03571009])
i1 = np.array([-0.97993473, -0.19784158,  0.02422123])
i2 = np.array([-0.99213354, -0.08369139,  0.09309589])
i3 = np.array([-0.9815966 , -0.18652938,  0.04092645])
i4 = np.array([-0.95584279, -0.29354905, -0.01390942])
i5 = np.array([-0.95465083, -0.29770515, -0.00367036])
i6 = np.array([-0.96049224, -0.27802831,  0.01244373])
i7 = np.array([-0.97446018, -0.2192203 ,  0.04868136])
i8 = np.array([-0.9861882 , -0.11388375,  0.12026347])
i9 = np.array([-0.93153253, -0.36297788, -0.02223087])
i10 = np.array([-0.97809693, -0.18126154,  0.10232631])
i11 = np.array([-0.97517664, -0.19717595,  0.10075785])
i12 = np.array([-0.91994918, -0.39203413,  0.00165933])
i13 = np.array([-0.92561202, -0.37757737,  0.02603279])
i14 = np.array([-9.08416105e-01, -4.18067185e-01, -1.47883523e-05])
i15 = np.array([-0.95094314, -0.29596307,  0.09007259])
i16 = np.array([-0.94304008, -0.31400878,  0.10988136])
i17 = np.array([-0.96368057, -0.20321331,  0.17327467])
i18 = np.array([-0.92873608, -0.35619264,  0.10283979])
i19 = np.array([-0.91838562, -0.38669481,  0.08387492])
i20 = np.array([-0.94375077, -0.25454761,  0.211045  ])


v = np.array([-0.95679541, -0.27661186,  0.08960151]) #boresight vector of the camera
...
#i_v_br = np.dot(main.Rz(np.radians(-s34.imu_tilt[2])), i_v_br1)
