...
ax.quiver([0], o[1], o[2], z_axis_new[0], z_axis_new[1], z_axis_new[2], color="b") #from iqb rotation
...
Bv = main.B(z_axis, v, 1)
Kv = main.K(Bv)
qv = main.q(Kv)
vRb = main.q2R(qv)
ax.quiver([0], o[1], o[2], v[0], v[1], v[2], color="violet")

gtcr = np.dot(np.transpose(vRb), gtc)
