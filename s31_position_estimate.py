...
'''
File returns position estimate for image belonging to s31 class
'''
...
from ost_output_papakolea import s31
...
phi = s31.imu_tilt[0] #roll
theta = s31.imu_tilt[1] #pitch
psi = s31.imu_tilt[2] #yaw

#converts star coordinates in GCRS (which is a ECI frame) to ITRS (which is a ECEF frame)
e = main.cel2ecef(s31.time, s31.cel[0], s31.radec, 'gcrs')
e1 = main.cel2ecef(s31.time, s31.cel[1], s31.radec, 'gcrs')
e2 = main.cel2ecef(s31.time, s31.cel[2], s31.radec, 'gcrs')
e3 = main.cel2ecef(s31.time, s31.cel[3], s31.radec, 'gcrs')
e4 = main.cel2ecef(s31.time, s31.cel[4], s31.radec, 'gcrs')
e5 = main.cel2ecef(s31.time, s31.cel[5], s31.radec, 'gcrs')
e6 = main.cel2ecef(s31.time, s31.cel[6], s31.radec, 'gcrs')
e7 = main.cel2ecef(s31.time, s31.cel[7], s31.radec, 'gcrs')
e8 = main.cel2ecef(s31.time, s31.cel[8], s31.radec, 'gcrs')
e9 = main.cel2ecef(s31.time, s31.cel[9], s31.radec, 'gcrs')
e10 = main.cel2ecef(s31.time, s31.cel[10], s31.radec, 'gcrs')
e11 = main.cel2ecef(s31.time, s31.cel[11], s31.radec, 'gcrs')
e12 = main.cel2ecef(s31.time, s31.cel[12], s31.radec, 'gcrs')
e13 = main.cel2ecef(s31.time, s31.cel[13], s31.radec, 'gcrs')
e14 = main.cel2ecef(s31.time, s31.cel[14], s31.radec, 'gcrs')
e15 = main.cel2ecef(s31.time, s31.cel[15], s31.radec, 'gcrs')
e16 = main.cel2ecef(s31.time, s31.cel[16], s31.radec, 'gcrs')
e17 = main.cel2ecef(s31.time, s31.cel[17], s31.radec, 'gcrs')
e18 = main.cel2ecef(s31.time, s31.cel[18], s31.radec, 'gcrs')
e19 = main.cel2ecef(s31.time, s31.cel[19], s31.radec, 'gcrs')
e20 = main.cel2ecef(s31.time, s31.cel[20], s31.radec, 'gcrs')
e21 = main.cel2ecef(s31.time, s31.cel[21], s31.radec, 'gcrs')
ev = main.cel2ecef(s31.time, s31.cel[13], s31.radec, 'radec2car')
...
#i_v_br = np.dot(main.Rz(np.radians(-s31.imu_tilt[2])), i_v_br1)
