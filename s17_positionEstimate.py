...
'''
File returns position estimate for image belonging to s17 class
'''
...
from ost_output_papakolea import s1, s17
...
phi = s17.imu_tilt[0] #roll
theta = s17.imu_tilt[1] #pitch
psi = s17.imu_tilt[2] #yaw

#converts star coordinates in GCRS (which is a ECI frame) to ITRS (which is a ECEF frame)
e = main.cel2ecef(s17.time, s17.cel[0], s17.radec, 'gcrs')
e1 = main.cel2ecef(s17.time, s17.cel[1], s17.radec, 'gcrs')
e2 = main.cel2ecef(s17.time, s17.cel[2], s17.radec, 'gcrs')
e3 = main.cel2ecef(s17.time, s17.cel[3], s17.radec, 'gcrs')
e4 = main.cel2ecef(s17.time, s17.cel[4], s17.radec, 'gcrs')
e5 = main.cel2ecef(s17.time, s17.cel[5], s17.radec, 'gcrs')
e6 = main.cel2ecef(s17.time, s17.cel[6], s17.radec, 'gcrs')
e7 = main.cel2ecef(s17.time, s17.cel[7], s17.radec, 'gcrs')
e8 = main.cel2ecef(s17.time, s17.cel[8], s17.radec, 'gcrs')
e9 = main.cel2ecef(s17.time, s17.cel[9], s17.radec, 'gcrs')
e10 = main.cel2ecef(s17.time, s17.cel[10], s17.radec, 'gcrs')
e11 = main.cel2ecef(s17.time, s17.cel[11], s17.radec, 'gcrs')
e12 = main.cel2ecef(s17.time, s17.cel[12], s17.radec, 'gcrs')
e13 = main.cel2ecef(s17.time, s17.cel[13], s17.radec, 'gcrs')
e14 = main.cel2ecef(s17.time, s17.cel[14], s17.radec, 'gcrs')
e15 = main.cel2ecef(s17.time, s17.cel[15], s17.radec, 'gcrs')
e16 = main.cel2ecef(s17.time, s17.cel[16], s17.radec, 'gcrs')
e17 = main.cel2ecef(s17.time, s17.cel[17], s17.radec, 'gcrs')
ev = main.cel2ecef(s17.time, s17.cel[17], s17.radec, 'radec2car')
...
i = np.array([-0.96840964, -0.23041157, -0.09535886])
i1 = np.array([-0.9770413 , -0.20432565, -0.06034373])
i2 = np.array([-0.96672713, -0.246684  , -0.06771704])
i3 = np.array([-0.92578561, -0.36116915, -0.11170444])
i4 = np.array([-0.94282119, -0.32527127, -0.07271041])
i5 = np.array([-0.93098893, -0.36329668, -0.0357102 ])
i6 = np.array([-0.96085092, -0.27600523,  0.02422113])
i7 = np.array([-0.96341712, -0.26486331,  0.04092634])
i8 = np.array([-0.92914039, -0.3694653 , -0.01390953])
i9 = np.array([-0.92761807, -0.37351208, -0.00367047])
i10 = np.array([-0.93502293, -0.35436872,  0.01244362])
i11 = np.array([-0.95367486, -0.29687446,  0.04868125])
i12 = np.array([-0.97383586, -0.19282222,  0.12026337])
i13 = np.array([-0.96035241, -0.2593311 ,  0.10232621])
i14 = np.array([-0.95616177, -0.27495912,  0.10075775])
i15 = np.array([-0.97441044, -0.13791904,  0.17748965])
i16 = np.array([-0.97213293, -0.15555985,  0.17538181])
i17 = np.array([-0.89225015, -0.45079037,  0.02603268])


v = np.array([-0.96976098, -0.2435383 ,  0.0158978 ]) #boresight vector of the camera
...
#i_v_br = np.dot(main.Rz(np.radians(-s17.imu_tilt[2])), i_v_br1)
