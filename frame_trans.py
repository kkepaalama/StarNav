...
E_EoS0 = np.array([-0.891385, -0.391212, 0.22888])
#E_EoS0 = m.cel2ecef(s1.time, s1.cel[0], s1.radec, 'sph')
...
B_BoS0 = np.array([0.987798, -0.130868, 0.0844351])
#B_BoS1 = m.body2enu(tilt, s1.body[1])
#B_BoS2 = m.body2enu(tilt, s1.body[2])
#B_BoS3 = m.body2enu(tilt, s1.body[3])
...
E_EoS0 = E_EoS0.reshape(3, 1)
 
EpB = E_EoS0 - E_BoS0

global_position = m.car2sph(EpB)
...
latitude = 13.231141639816727  # San Francisco latitude in degrees
longitude = -156.30423922737765  # San Francisco longitude in degrees
altitude = 10**10  # Altitude above sea level in meters

x, y, z = m.lla2ecef(latitude, longitude, altitude)
print(f"ECEF Coordinates: ({x} m, {y} m, {z} m)")
