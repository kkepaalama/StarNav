...
'''
File returns position estimate for image belonging to s35 class
'''
...
from ost_output_papakolea import s35
...
phi = s35.imu_tilt[0] #roll
theta = s35.imu_tilt[1] #pitch
psi = s35.imu_tilt[2] #yaw

#converts star coordinates in GCRS (which is a ECI frame) to ITRS (which is a ECEF frame)
e = main.cel2ecef(s35.time, s35.cel[0], s35.radec, 'gcrs')
e1 = main.cel2ecef(s35.time, s35.cel[1], s35.radec, 'gcrs')
e2 = main.cel2ecef(s35.time, s35.cel[2], s35.radec, 'gcrs')
e3 = main.cel2ecef(s35.time, s35.cel[3], s35.radec, 'gcrs')
e4 = main.cel2ecef(s35.time, s35.cel[4], s35.radec, 'gcrs')
e5 = main.cel2ecef(s35.time, s35.cel[5], s35.radec, 'gcrs')
e6 = main.cel2ecef(s35.time, s35.cel[6], s35.radec, 'gcrs')
e7 = main.cel2ecef(s35.time, s35.cel[7], s35.radec, 'gcrs')
e8 = main.cel2ecef(s35.time, s35.cel[8], s35.radec, 'gcrs')
e9 = main.cel2ecef(s35.time, s35.cel[9], s35.radec, 'gcrs')
e10 = main.cel2ecef(s35.time, s35.cel[10], s35.radec, 'gcrs')
e11 = main.cel2ecef(s35.time, s35.cel[11], s35.radec, 'gcrs')
e12 = main.cel2ecef(s35.time, s35.cel[12], s35.radec, 'gcrs')
e13 = main.cel2ecef(s35.time, s35.cel[13], s35.radec, 'gcrs')
e14 = main.cel2ecef(s35.time, s35.cel[14], s35.radec, 'gcrs')
e15 = main.cel2ecef(s35.time, s35.cel[15], s35.radec, 'gcrs')
e16 = main.cel2ecef(s35.time, s35.cel[16], s35.radec, 'gcrs')
e17 = main.cel2ecef(s35.time, s35.cel[17], s35.radec, 'gcrs')
e18 = main.cel2ecef(s35.time, s35.cel[18], s35.radec, 'gcrs')
e19 = main.cel2ecef(s35.time, s35.cel[19], s35.radec, 'gcrs')
e20 = main.cel2ecef(s35.time, s35.cel[20], s35.radec, 'gcrs')
e21 = main.cel2ecef(s35.time, s35.cel[21], s35.radec, 'gcrs')
ev = main.cel2ecef(s35.time, s35.cel[13], s35.radec, 'radec2car')
...
i = np.array([-0.95812672, -0.28410925, -0.03571009])
i1 = np.array([-0.98057867, -0.19462491,  0.02422124])
i2 = np.array([-0.99240283, -0.0804353 ,  0.09309589])
i3 = np.array([-0.98220341, -0.18330732,  0.04092645])
i4 = np.array([-0.95680091, -0.29041093, -0.01390942])
i5 = np.array([-0.95562259, -0.29457091, -0.00367036])
i6 = np.array([-0.9613994 , -0.27487501,  0.01244373])
i7 = np.array([-0.97517429, -0.21602149,  0.04868136])
i8 = np.array([-0.98655659, -0.11064701,  0.12026347])
i9 = np.array([-0.93271861, -0.35991916, -0.02223086])
i10 = np.array([-0.98622511, -0.10270113,  0.12966266])
i11 = np.array([-0.97868646, -0.17805099,  0.10232631])
i12 = np.array([-0.97581841, -0.19397489,  0.10075786])
i13 = np.array([-0.92123066, -0.38901326,  0.00165933])
i14 = np.array([-0.92684603, -0.37453799,  0.0260328 ])
i15 = np.array([-9.09783079e-01, -4.15084016e-01, -1.47836850e-05])
i16 = np.array([-0.9519092 , -0.29284101,  0.0900726 ])
i17 = np.array([-0.9440654 , -0.31091256,  0.10988137])
i18 = np.array([-0.96434222, -0.20004995,  0.17327468])
i19 = np.array([-0.9298999 , -0.35314313,  0.10283979])
i20 = np.array([-0.91964959, -0.38367909,  0.08387492])
i21 = np.array([-0.94458097, -0.25144938,  0.21104501])


v = np.array([-0.95680056, -0.27657209,  0.08966925]) #boresight vector of the camera
...
#i_v_br = np.dot(main.Rz(np.radians(-s35.imu_tilt[2])), i_v_br1)
