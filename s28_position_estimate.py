...
'''
File returns position estimate for image belonging to s28 class
'''
...
from ost_output_papakolea import s28
...
phi = s28.imu_tilt[0] #roll
theta = s28.imu_tilt[1] #pitch
psi = s28.imu_tilt[2] #yaw

#converts star coordinates in GCRS (which is a ECI frame) to ITRS (which is a ECEF frame)
e = main.cel2ecef(s28.time, s28.cel[0], s28.radec, 'gcrs')
e1 = main.cel2ecef(s28.time, s28.cel[1], s28.radec, 'gcrs')
e2 = main.cel2ecef(s28.time, s28.cel[2], s28.radec, 'gcrs')
e3 = main.cel2ecef(s28.time, s28.cel[3], s28.radec, 'gcrs')
e4 = main.cel2ecef(s28.time, s28.cel[4], s28.radec, 'gcrs')
e5 = main.cel2ecef(s28.time, s28.cel[5], s28.radec, 'gcrs')
e6 = main.cel2ecef(s28.time, s28.cel[6], s28.radec, 'gcrs')
e7 = main.cel2ecef(s28.time, s28.cel[7], s28.radec, 'gcrs')
e8 = main.cel2ecef(s28.time, s28.cel[8], s28.radec, 'gcrs')
e9 = main.cel2ecef(s28.time, s28.cel[9], s28.radec, 'gcrs')
e10 = main.cel2ecef(s28.time, s28.cel[10], s28.radec, 'gcrs')
e11 = main.cel2ecef(s28.time, s28.cel[11], s28.radec, 'gcrs')
e12 = main.cel2ecef(s28.time, s28.cel[12], s28.radec, 'gcrs')
e13 = main.cel2ecef(s28.time, s28.cel[13], s28.radec, 'gcrs')
e14 = main.cel2ecef(s28.time, s28.cel[14], s28.radec, 'gcrs')
e15 = main.cel2ecef(s28.time, s28.cel[15], s28.radec, 'gcrs')
e16 = main.cel2ecef(s28.time, s28.cel[16], s28.radec, 'gcrs')
e17 = main.cel2ecef(s28.time, s28.cel[17], s28.radec, 'gcrs')
e18 = main.cel2ecef(s28.time, s28.cel[18], s28.radec, 'gcrs')
e19 = main.cel2ecef(s28.time, s28.cel[19], s28.radec, 'gcrs')
e20 = main.cel2ecef(s28.time, s28.cel[20], s28.radec, 'gcrs')
ev = main.cel2ecef(s28.time, s28.cel[13], s28.radec, 'radec2car')
...
i = np.array([-0.95146002, -0.3056938 , -0.03571012])
i1 = np.array([-0.9759289 , -0.21673983,  0.02422121])
i2 = np.array([-0.97780905, -0.20546185,  0.04092642])
i3 = np.array([-0.94999211, -0.3119639 , -0.01390945])
i4 = np.array([-0.94872006, -0.31609619, -0.00367039])
i5 = np.array([-0.95494059, -0.29653589,  0.0124437 ])
i6 = np.array([-0.97004227, -0.23800877,  0.04868133])
i7 = np.array([-0.98380351, -0.13291851,  0.12026345])
i8 = np.array([-0.92434482, -0.38091003, -0.0222309 ])
i9 = np.array([-0.98365172, -0.12496716,  0.12966264])
i10 = np.array([-0.97441181, -0.20012737,  0.10232628])
i11 = np.array([-0.97118456, -0.21598238,  0.10075783])
i12 = np.array([-0.91220218, -0.40973703,  0.0016593 ])
i13 = np.array([-0.900168228, -0.435542365, -0.0000148159618])
i14 = np.array([-0.91814331, -0.39539239,  0.02603277])
i15 = np.array([-0.94504673, -0.3142828 ,  0.09007257])
i16 = np.array([-0.93679645, -0.33217243,  0.10988134])
i17 = np.array([-0.95957398, -0.22179648,  0.17327465])
i18 = np.array([-0.92168   , -0.37407202,  0.10283976])
i19 = np.array([-0.91074209, -0.40436849,  0.08387489])
i20 = np.array([-0.93865597, -0.2727361 ,  0.21104498])


v = np.array([-0.95684002, -0.27640169,  0.08977344]) #boresight vector of the camera
...
#i_v_br = np.dot(main.Rz(np.radians(-s28.imu_tilt[2])), i_v_br1)
